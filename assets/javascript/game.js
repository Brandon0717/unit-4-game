$(document).ready(function(){
  ...
  var compPick = Math.floor(Math.random() * 102) + 19; 
	...
	var gemOne = Math.floor(Math.random() * 12) + 1; 
		...
		$("#img1").html("<img src=" + "assets/images/blue.png" + " value=" + gemOne + ">"); 

	var gemTwo = Math.floor(Math.random() * 12) + 1; 
		console.log("Gem 2: " + gemTwo); 
		$("#img2").html("<img src=" + "assets/images/green.png" + " value=" + gemTwo + ">"); 

	var gemThree = Math.floor(Math.random() * 12) + 1; 
		console.log("Gem 3: " + gemThree); 
		$("#img3").html("<img src=" + "assets/images/red.png" + " value=" + gemThree + ">");
	
	var gemFour = Math.floor(Math.random() * 12) + 1; 
		console.log("Gem 4: " + gemFour); 
		$("#img4").html("<img src=" + "assets/images/yellow.png" + " value=" + gemFour + ">");
